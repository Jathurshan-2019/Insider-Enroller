...
echo "StickyMessage"="{\"Message\":\"Device Enrolled to Windows Insider Program Using Insider_Enroller v%scriptver%\",\"LinkTitle\":\"\",\"LinkUrl\":\"\",\"DynamicXaml\":\"^<StackPanel xmlns=\\\"http://schemas.microsoft.com/winfx/2006/xaml/presentation\\\"^>^<TextBlock Style=\\\"{StaticResource BodyTextBlockStyle }\\\"^>This device has been enrolled to the Windows Insider program using Insider_Enroller v%scriptver%. If you want to change settings of the enrollment or stop receiving Insider Preview builds, please use the Insider_Enroller script. ^<Hyperlink NavigateUri=\\\"https://github.com/Jathurshan-2019/Insider-Enroller\\\" TextDecorations=\\\"None\\\"^>Learn more about Insider_Enroller Script^</Hyperlink^>^</TextBlock^>^<TextBlock Text=\\\"Applied Windows Insider Channel Settings\\\" Margin=\\\"0,20,0,10\\\" Style=\\\"{StaticResource SubtitleTextBlockStyle}\\\" /^>^<TextBlock Style=\\\"{StaticResource BodyTextBlockStyle }\\\" Margin=\\\"0,0,0,5\\\"^>^<Run FontFamily=\\\"Segoe MDL2 Assets\\\"^>^&#xECA7;^</Run^> ^<Span FontWeight=\\\"SemiBold\\\"^>%Fancy%^</Span^>^</TextBlock^>^<TextBlock Text=\\\"Channel: %Channel% Channel\\\" Style=\\\"{StaticResource BodyTextBlockStyle }\\\" /^>^<TextBlock Text=\\\"Content: %Content%\\\" Style=\\\"{StaticResource BodyTextBlockStyle }\\\" /^>^<TextBlock Text=\\\"Diagnostics Settings Note:\\\" Margin=\\\"0,20,0,10\\\" Style=\\\"{StaticResource SubtitleTextBlockStyle}\\\" /^>^<TextBlock Style=\\\"{StaticResource BodyTextBlockStyle }\\\"^>Windows Insider Preview builds require Diagnostic data collection settings to be set to ^<Span FontWeight=\\\"SemiBold\\\"^>Required + Optional^</Span^>. You can modify your current settings in ^<Span FontWeight=\\\"SemiBold\\\"^>Diagnostics ^&amp; feedback^</Span^>.^</TextBlock^>^<Button Command=\\\"{StaticResource ActivateUriCommand}\\\" CommandParameter=\\\"ms-settings:privacy-feedback\\\" Margin=\\\"0,10,0,0\\\"^>^<TextBlock Margin=\\\"5,0,5,0\\\"^>Open Diagnostics ^&amp; feedback^</TextBlock^>^</Button^>^</StackPanel^>\",\"Severity\":0}"
echo.
)>"%SystemRoot%\oie.reg"
...
echo =========================================================
echo     Preview Builds are enabled from %Channel% Channel
echo =========================================================
...
echo Applied Changes
echo ==================================
echo     Preview Builds are stopped
echo ==================================
call :RESET_INSIDER_CONFIG 1>nul 2>nul
...
echo Because Micrsoft Flight Signing is Disabled.
echo It will be Enabled After Restart.
