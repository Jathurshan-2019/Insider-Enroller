...
if %build% LSS 17763 (
    ...
    echo =============================================================
    echo Download Latest Version Windows 10 at
    echo Download Windows 11 at 
    echo.
    pause
    goto :EOF
)
...
echo Note: If you have supported system for Windows 11 run "Insider_Enroller_W10_W11.cmd"
...
rem reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\WindowsUpdate\SLS\Programs\RingPreview" /f
rem reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\WindowsUpdate\SLS\Programs\RingInsiderSlow" /f
rem reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\WindowsUpdate\SLS\Programs\RingInsiderFast" /f
...
reg add "HKEY_LOCAL_MACHINE\SYSTEM\Setup\LabConfig" /f /t REG_DWORD /v BypassProcessorCheck /d 1
